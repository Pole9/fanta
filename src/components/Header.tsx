      ...
      <div className="w-full flex items-center justify-between gap-1 text-xs">
        ...
        <div className="flex items-center gap-1.5 flex-shrink-0">
          ...
          <a
            ...
            className="h-7 w-7 rounded-lg flex items-center justify-center transition-all border border-slate-750 bg-slate-950 text-slate-300 hover:text-white hover:bg-slate-800 hover:border-slate-600 shadow-sm active:scale-95"
